...
exports.paystackWebhook = functions.https.onRequest(async (request, response) => {
    ...
    try {
        ...
        const teacher = await collections_1.teacherCol.doc((_b = timeSlot.data()) === null || _b === void 0 ? void 0 : _b.teacherId).get();
        ...
        const confirmPaymentData = {
            ...
            bookByWho: bookByWho,
            teacher: {
                name: (_e = teacher.data()) === null || _e === void 0 ? void 0 : _e.name,
                picture: (_f = teacher.data()) === null || _f === void 0 ? void 0 : _f.picture,
            },
