...
import 'package:halo_teacher/app/modules/teacher_detail_order/views/widgets/user_order_tile.dart';
import 'package:halo_teacher/app/modules/teacher_detail_order/views/widgets/video_call_button.dart';
import 'package:halo_teacher/app/utils/constants/constants.dart';
import 'package:halo_teacher/app/utils/styles/styles.dart';
import 'package:halo_teacher/app/utils/timeformat.dart';

import '../controllers/teacher_detail_order_controller.dart';

class TeacherDetailOrderView extends GetView<TeacherDetailOrderController> {
  const TeacherDetailOrderView({Key? key}) : super(key: key);
  @override
