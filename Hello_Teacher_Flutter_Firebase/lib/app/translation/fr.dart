const Map<String, String> fr = {
  ...
  'Top Rated Teacher': 'Médecin le mieux noté',
  'Search Teacher': 'Rechercher un médecin',
  'View All': 'Voir tout',
  'error ': 'Erreur ',
  'Top Rated Teacher is empty ': 'Le médecin le mieux noté est vide ',
  'Home': 'Accueil',
  'Teacher': 'Docteur',
  ...
  'Payment for Teacher ': 'Le paiement du médecin ',
  ...
  'Send': 'Envoyer',
  'Teacher no longger exist': 'Le médecin n\'existe plus',
  ...
  'Login': 'Connexion',
  'Review Teacher': 'Notez le medecin',
